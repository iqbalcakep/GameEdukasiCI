            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Daftar Tipe Soal</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Tipe Soal</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                <a href="<?= base_url() ?>/index.php/tipe/addTipe" class="btn btn-success btn-rounded mb-4">
                                    Tambah Tipe Soal</a>
                                <div class="table-responsive">
                                    <table class="table" id="example">
                                        ...
                                        <tbody>
                                        <?php $no=1; foreach ($tipe as $data) : ?>
                                            <tr>
                                                <td><?php echo $no ?></td>
                                                <td><?php echo $data->tipe ?></td>
                                                <td>
                                                    <?php if ($data->metode == 'pg') { ?>
                                                        Pilihan Ganda
                                                    <?php } else if ($data->metode == 'isian') { ?>
                                                        Isian
                                                    <?php } ?>
                                                    </td>
                                                <td><?php echo $data->deskripsi ?></td>
                                                <td>
                                                    <a href="<?php echo base_url('index.php/Tipe/delete/'.$data->id_tipe) ?>" class="btn btn-danger btn-rounded mb-4" style="color: white">Delete</a>
                                                </td>
                                            </tr>
                                        <?php $no++; endforeach; ?>
                                        </tbody>
